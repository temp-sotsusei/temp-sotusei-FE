    ...
    <div className="flex flex-col items-center w-full px-4 md:px-10 py-8 space-y-8 md:space-y-9">
      ...
      <div className="w-full md:w-4/5 flex flex-col space-y-8 md:space-y-9">
        {chapters.map((chapter, idx) => (
          <div key={idx} className="flex flex-col space-y-4 md:space-y-5 border border-gray-300 rounded-md p-4 md:p-5">

            <div className="text-base md:text-lg font-bold">第{idx + 1}章</div>
            ...
            <div className="flex flex-wrap gap-2 md:gap-3">
              {chapter.words.slice(0, 4).map((word, wIdx) => (
                <div
                  key={wIdx}
